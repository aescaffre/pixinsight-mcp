...
1. **Contrast curves** (CurvesTransformation on L/RGB channel)
   ...
   - S-curve for contrast: pull shadows down slightly, push highlights gently
   - Conservative: [[0,0],[0.10,0.08],[0.50,0.52],[0.90,0.93],[1,1]]
   - Balanced: [[0,0],[0.10,0.06],[0.50,0.55],[0.90,0.94],[1,1]]
   - Assertive: [[0,0],[0.08,0.04],[0.50,0.58],[0.90,0.95],[1,1]]
